...
enum AccessibilityID {
    ...
    enum Trends {
        ...
        static let qualityDimension = "Trends.Quality.Dimension" // append ".\(dimension)"
        static let fixCard = "Trends.FixCard"                    // append ".\(issueKind)"
        ...
        static let expertCard = "Trends.ExpertCard"              // append ".\(index)"
